...
ActiveRecord::Schema.define(version: 2020_10_19_035929) do
  ...
  create_table "chatgroups", force: :cascade do |t|
    ...
    t.index ["users_id"], name: "index_chatgroups_on_users_id"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "email"
    t.string "password"
    t.string "resumeprofile"
    t.string "photoprofile"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  add_foreign_key "chatgroups", "users", column: "users_id"
